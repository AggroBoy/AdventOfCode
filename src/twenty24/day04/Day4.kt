package twenty24.day04

import util.printTimedOutput
import java.io.File

fun main() {
    printTimedOutput("Puzzle 1 test") { puzzle1("input/2024/day4-test.txt") }
    printTimedOutput("Puzzle 1     ") { puzzle1("input/2024/day4.txt") }
    printTimedOutput("Puzzle 2 test") { puzzle2("input/2024/day4-test.txt") }
    printTimedOutput("Puzzle 2     ") { puzzle2("input/2024/day4.txt") }
}
