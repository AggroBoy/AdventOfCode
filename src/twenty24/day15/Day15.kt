...
fun main() {
    printTimedOutput("Puzzle 1 test") { puzzle1("input/2024/day15-test.txt") }
    printTimedOutput("Puzzle 1     ") { puzzle1("input/2024/day15.txt") }
    printTimedOutput("Puzzle 2 test") { puzzle2("input/2024/day15-test.txt") }
    printTimedOutput("Puzzle 2     ") { puzzle2("input/2024/day15.txt") }
}
