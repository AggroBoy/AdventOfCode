...
fun main() {
    printTimedOutput("Puzzle 1 test") { solver("input/2022/day17-test.txt", 2022) }
    printTimedOutput("Puzzle 1     ") { solver("input/2022/day17.txt", 2022) }
    printTimedOutput("Puzzle 2 test") { solver("input/2022/day17-test.txt", 1000000000000) }
    printTimedOutput("Puzzle 2     ") { solver("input/2022/day17.txt", 1000000000000) }
}
