...
fun main(args: Array<String>) {
    println("Puzzle 1 (test): ${puzzle1("input/2022/day15-test.txt", 10)}")
    println("Puzzle 1: ${puzzle1("input/2022/day15.txt", 2000000)}")
    println("Puzzle 2: ${puzzle2("input/2022/day15.txt")}")
}
